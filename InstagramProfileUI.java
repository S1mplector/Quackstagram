...
public class InstagramProfileUI extends JFrame {
    ...
    private static final int GRID_IMAGE_SIZE = Config.FRAME_WIDTH / 3; // Static size for grid images
    ...
    private final JPanel navigationPanel; // Panel for the navigation
